-- This is a deprecated definition of a module, don't use it.
...
function new()
	...
	-- Some text
	local text1 = display.newText('Deprecated scene definition. Touch to go back.', 0, 0, native.systemFontBold, 18)
	text1:setTextColor(255, 150, 150)
	text1.x = _CX
	text1.y = _CY
	-- On text touch
